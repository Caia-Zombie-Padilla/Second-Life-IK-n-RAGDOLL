...
llRagDollStop(); // stops the physical ragdon and returns to animation with the same flags used previously in llRagDoll or llRagDollLimited
...
//      3D PARTICLES FUNCTIONS, client side only. max part. count: 8
...
ll3DparticleSound (Sound_UUID, Volume);  // triggers a collision sound, non loop
